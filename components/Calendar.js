...
export default function Calendar(props) {
  ...
  const [selectedMonth, setSelectedMonth] = useState(monthsArr[currMonth]); // Use array destructuring
  ...
  console.log('SELECTED MONTH:', selectedMonth); // This will now log the correct selected month
  ...
  return (
    <div className='flex flex-col gap-2'>
        <div className='grid grid-cols-5 gap-4'>
            ...
            <p className={'text-center col-span-3 capitalized textGradient whitespace-nowrap ' + fugaz.className} >{selectedMonth}, {selectedYear}</p>
            <button onClick={() => {
                handleIncrementMonth(+1)
